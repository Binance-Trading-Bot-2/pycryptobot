[![Docker](https://github.com/Binance-Trading-Bot-2/pycryptobot/actions/workflows/container.yml/badge.svg)](https://github.com/Binance-Trading-Bot-2/pycryptobot/actions/workflows/container.yml/badge.svg) [![Tests](https://github.com/Binance-Trading-Bot-2/pycryptobot/actions/workflows/unit-tests.yml/badge.svg)](https://github.com/Binance-Trading-Bot-2/pycryptobot/actions/workflows/unit-tests.yml/badge.svg)
...
### Manual
    ...
    % git clone https://github.com/Binance-Trading-Bot-2/pycryptobot
    % cd pycryptobot
...
From Github image repo
    ...
    % docker pull ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest
    latest: Pulling from Binance-Trading-Bot-2/pycryptobot/pycryptobot
    ...
    Status: Downloaded newer image for ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest
    ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest
...
### Docker (Option 1)
    ...
    Daemon:
    % docker run --name BTC-GBP -v /home/example/config.json:/app/config.json -d ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest <arguments>

    Example:
    % docker run --name BTC-GBP -v /Users/whittlem/Documents/Repos/Docker/config.json:/app/config.json -d ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest --live 0
    e491ae4fdba28aa9e74802895adf5e856006c3c63cf854c657482a6562a1e15

    Interactive:
    % docker run --name BTC-GBP -v /home/example/config.json:/app/config.json -it ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest <arguments>
    ...
    e491ae4fdba2   ghcr.io/Binance-Trading-Bot-2/pycryptobot/pycryptobot:latest   "python3 pycryptobot…"   46 seconds ago   Up 44 seconds             BTC-GBP
